...
export const elements = {
  ...
  special: document.getElementById("special") as HTMLParagraphElement,  // New element
} as const;

export type TSong = {
  name: string;
  artist: string;
  special: string | null;  // New property
};
...
export class State {
  ...
  set song(newSong) {
    ...
    elements.special.innerHTML = newSong.special ? `Special: <b>${newSong.special}</b>` : '';
  }
}
